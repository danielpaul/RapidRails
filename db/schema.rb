...
ActiveRecord::Schema[8.0].define(version: 20_250_122_080_031) do
  ...
  create_table "user_account_feedbacks", force: :cascade do |t|
    t.bigint "user_id", null: false
    t.string "feedback"
    t.datetime "created_at", null: false
    t.index ["user_id"], name: "index_user_account_feedbacks_on_user_id"
  end
  ...
  add_foreign_key "user_account_feedbacks", "users"
end
