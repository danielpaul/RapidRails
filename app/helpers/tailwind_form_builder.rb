...
class TailwindFormBuilder < ActionView::Helpers::FormBuilder
  ...
  TEXT_FIELD_STYLE = 'block w-full rounded-md border-0 py-1.5 shadow-sm ring-1 ring-inset ring-gray-300 dark:ring-grey placeholder:text-grey focus:ring-2 focus:ring-inset focus:ring-blue-600 sm:text-sm sm:leading-6 text-slate-800 dark:bg-card-dark dark:text-light'.freeze
